...
{
	$temp_location = 'uploads/offer-banner-images/temp_file/';
	$size_location1 = 'uploads/offer-banner-images/size_extra_small/';
	$size_location2 = 'uploads/offer-banner-images/size_small/';
	$size_location3 = 'uploads/offer-banner-images/size_medium/';
	$size_location4 = 'uploads/offer-banner-images/size_large/';
