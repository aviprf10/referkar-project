...
if ($admin == 1)
{
    if (isset($_POST))
    {
        ...
        if (!empty($all_category_data_array))
        {
            ...
            $get_category_title_query = "select * from sub_sub_category where sub_sub_category_name='$sub_sub_category_name' AND sub_category_id='$sub_category_id' AND id!='$edit_id' and is_deleted='0'";
            ...
            $update_category_query = "update sub_sub_category set sub_sub_category_name='$sub_sub_category_name', sub_category_id='$sub_category_id', category_id='$category_id', meta_title='$meta_title', meta_keyword='$search_keywords', meta_description='$meta_description',updated_on='$updated_on',
            ...
            if ($result_update_category_query)
            {
                ...
                $return["html_message"] = 'Sub Sub Category Updated Successfully.';
                $return["status"] = "success";
                $return["update"] = 1;
                echo json_encode($return);
                exit();
