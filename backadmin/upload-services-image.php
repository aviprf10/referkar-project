...
if ($admin == 1)
{
	$temp_location = 'uploads/services-images/temp_file/';
	$size_location1 = 'uploads/services-images/size_extra_small/';
	$size_location2 = 'uploads/services-images/size_small/';
	$size_location3 = 'uploads/services-images/size_medium/';
	$size_location4 = 'uploads/services-images/size_large/';
