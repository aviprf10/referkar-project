...
if ($admin == 1)
{
    if (isset($_POST))
    {
        ...
        if (!empty($all_category_data_array))
        {
            ...
            $update_category_query = "update category set category_name='$category_name', updated_on='$updated_on', meta_title='$meta_title', meta_keyword='$search_keywords', meta_description='$meta_description',
