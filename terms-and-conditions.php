                        ...
                        <div class="about-four__right">
                            <div class="section-title text-left">
                                <div class="section-sub-title-box">
                                    <p class="section-sub-title">Terms & Condition company</p>
                            ...
                            <p class="about-four__text-1"><?php if(!empty($main_title)){ echo ucfirst($main_title); }else{ echo 'Title Not Available'; } ?></p>
