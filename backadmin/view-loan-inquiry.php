...
if ($admin == 1 || ($sub_admin == 1 && $is_country_read == 1))
{
                            ...
                            <div class="table-responsive">
                                <div class="card">
                                    <table
                                        ...
                                        <tr>
                                            <td></td>
                                            <td><input type="text" id="search_refernceno" name="search_refernceno"
                                                       class="<?php echo $module_name; ?>-search-input form-control">
                                            </td>
                                            <td><input type="text" id="search_name" name="search_name"
                                                       class="<?php echo $module_name; ?>-search-input form-control">
                                            </td>
                                            <td><input type="text" id="search_refer_name" name="search_refer_name"
                                                       class="<?php echo $module_name; ?>-search-input form-control">
                                            </td>
                                            <td><input type="text" id="search_loan_type" name="search_loan_type"
                                                       class="<?php echo $module_name; ?>-search-input form-control">
                                            </td>
                                            <td><input type="text" id="search_loan_amount" name="search_loan_amount"
                                                       class="<?php echo $module_name; ?>-search-input form-control">
                                            </td>
                                            <td><input type="date" id="search_created_on" name="search_created_on"
                                                       class="<?php echo $module_name; ?>-search-input form-control">
                                            </td>
                                            <td>
    ...
    //            debugger;
                if (reset_flag == 0)            //call to load_data() when on first table load or when search button is clicked
                {
                    ...
                    form_data =
                    {
                        "search_refernceno": $('#search_refernceno').val(),
                        "search_name": $('#search_name').val(),
                        "search_refer_name": $('#search_refer_name').val(),
                        "search_loan_type": $('#search_loan_type').val(),
                        "search_loan_amount": $('#search_loan_amount').val(),
                        "search_created_on": $('#search_created_on').val(),
                        "search_status": search_status
                    };
                }
                else if (reset_flag == 1)           //call to load_data() when reset button is clicked
                {
                    $('#search_refernceno').val('');
                    $('#search_name').val('');
                    $('#search_refer_name').val('');
                    $('#search_loan_type').val('');
                    $('#search_loan_amount').val('');
                    $('#search_created_on').val('');
