                                    ...
                                    <div class="table-responsive">
                                        <table
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" id="search_unit_title" name="search_unit_title"
                                                           class="<?php echo $module_name; ?>-search-input form-control">
                                                </td>
                                                <td>
...
//            debugger;
            if (reset_flag == 0)            //call to load_data() when on first table load or when search button is clicked
            {
                ...
                form_data =
                {
                    "search_unit_title": $('#search_unit_title').val(),
                    "search_unit_code": $('#search_unit_code').val(),
                    "search_status": search_status
                };
            }
            else if (reset_flag == 1)           //call to load_data() when reset button is clicked
            {
                $('#search_unit_title').val('');
                $('#search_unit_code').val('');
        ...
        $("#search_unit_title,#search_unit_code").on("keydown", function (e) {
            if (e.keyCode === 13) {  //checks whether the pressed key is "Enter"
                load_data();
            }
        });
