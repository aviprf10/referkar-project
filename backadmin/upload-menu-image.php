...
if ($admin == 1)
{
	$temp_location = 'uploads/menu-images/temp_file/';
	$size_location1 = 'uploads/menu-images/size_extra_small/';
	$size_location2 = 'uploads/menu-images/size_small/';
	$size_location3 = 'uploads/menu-images/size_medium/';
	$size_location4 = 'uploads/menu-images/size_large/';
