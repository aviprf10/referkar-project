...
{
	$temp_location = 'uploads/cms-images/temp_file/';
	$size_location1 = 'uploads/cms-images/size_extra_small/';
	$size_location2 = 'uploads/cms-images/size_small/';
	$size_location3 = 'uploads/cms-images/size_medium/';
	$size_location4 = 'uploads/cms-images/size_large/';
	...
	if(move_uploaded_file($_FILES['uploadfile']['tmp_name'], $source_image_path)) 
	{
		...
		resize_image($source_image_path, 570,330, $destination_file_name,$size_location4,75);
