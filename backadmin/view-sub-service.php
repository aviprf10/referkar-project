                                ...
                                <div class="card">
                                    <table
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="search_service_title" name="search_service_title"
                                                       class="<?php echo $module_name; ?>-search-input form-control">
                                            </td>
                                            <td><input type="text" id="search_subservice_title" name="search_subservice_title"
                                                       class="<?php echo $module_name; ?>-search-input form-control">
                                            </td>
                                            <td>
        ...
        <script type="text/javascript">
            ...
            function load_data(reset_flag = 0)
            {
                ...
                if (reset_flag == 0) 
                {
                    ...
                    form_data =
                    {
                        "search_service_title": $('#search_service_title').val(),
                        "search_subservice_title": $('#search_subservice_title').val(),
                        "search_status": search_status
                    };
                }
                else if (reset_flag == 1)           //call to load_data() when reset button is clicked
                {
                    $('#search_service_title').val('');
                    $('#search_subservice_title').val('');

                    form_data =
                    {
                        "search_service_title": '',
                        "search_subservice_title": '',
                        "search_status": ''
                    }
                }
            ...
            $("#search_service_title,#search_subservice_title").on("keydown", function (e) {
                if (e.keyCode === 13) {  //checks whether the pressed key is "Enter"
                    load_data();
                }
            });
