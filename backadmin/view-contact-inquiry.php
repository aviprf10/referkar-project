...
if ($admin == 1)
{
    $module_full_name = "Contact Inquiry";
    $module_short_name = "Contact Inquiry";
    $module_name = "contact-inquiry";
    ?>
    <!DOCTYPE html>
    <html lang="en">
    <head>
...
//            debugger;
        ...
        $("#search_name,#search_email, #search_description, #search_mobile").on("keydown", function (e) {
            if (e.keyCode === 13) {  //checks whether the pressed key is "Enter"
                load_data();
            }
        });
