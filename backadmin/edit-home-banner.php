                                                                    ...
                                                                    <div id="upload<?php echo $i; ?>"
                                                                        ...
                                                                        <ul class="" id="files<?php echo $i; ?>"
                                                                            ...
                                                                            <?php
                                                                                ...
                                                                                {
                                                                                    ?>
                                                                                    <img src="<?php echo $base_url; ?>uploads/home-banner-small-images/size_small/<?php echo $edit_data_array[0]['small_images']; ?>"
                                                                    ...
                                                                    <div id="upload<?php echo $i; ?>"
                                                                        ...
                                                                        <ul class="" id="files<?php echo $i; ?>"
                                                                            ...
                                                                            <?php
                                                                                ...
                                                                                {
                                                                                    ?>
                                                                                    <img src="<?php echo $base_url; ?>uploads/home-banner-images/size_small/<?php echo $edit_data_array[0]['images']; ?>"
                                                                                         style="margin-bottom:20px;width:295px;height:160px;">
                                                                                    <div style="clear:both"></div>
                                                                                    <center><a class="" style="cursor:pointer" onclick="delete_upload(<?php echo $i; ?>)">
                                                                                            <i class="icon icon-subtract"></i>
