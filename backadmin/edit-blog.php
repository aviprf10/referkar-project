...
if ($admin == 1 || ($sub_admin == 1 && $is_country_read == 1))
{
    if (isset($_GET['id']))
    {
        ...
        $get_blog_query = "select * from blogs where id='$edit_id' and is_deleted='0'";
        $result_get_blog_query = mysqli_query($db_mysqli, $get_blog_query);
        while ($row_get_blog_query = mysqli_fetch_assoc($result_get_blog_query))
        {
            $edit_data_array[] = $row_get_blog_query;
        }
         ...
         if (count($edit_data_array) > 0)
        {
            ...
            $subcategory_id = $edit_data['subcategory_id'];
            $service_id = $edit_data['service_id'];
            $service_sub_id = $edit_data['service_sub_id'];
            $blog_name = $edit_data['blog_name'];
            $blog_image = $edit_data['blog_image'];
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3" id="subcategory_div">
                                                    <div class="form-group">
                                                        ...
                                                        $get_sub_category_query = "select * from sub_category where id IN($subcategory_id) and is_deleted='0'";
                                                        ...
                                                        { ?>
                                                            <option
                                                                <?php
                                                                    if (in_array($all_sub_category_data['id'], explode(',', $subcategory_id)))
                                                                    {
                                                                        echo " selected='selected'";
                                                                    }
                                                                    ?>
                                                                value="<?php echo $all_sub_category_data['id']; ?>"
                                                                <?php if ($all_sub_category_data['id'] == $subcategory_id)
                                                                {
                                                                    echo " selected='selected'";
                                                                } ?>>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="select-search form-control" id="service_id" 
                                                            ...
                                                            { ?>
                                                                ...
                                                                <?php
                                                                            if (in_array($all_service_data['id'], explode(',', $service_id)))
                                                                            {
                                                                                echo " selected='selected'";
                                                                            }
                                                                            ?>
                                                                    value="<?php echo $all_service_data['id']; ?>"
                                                                    <?php if ($all_service_data['id'] == $service_id)
                                                                        {
                                                                            echo " selected='selected'";
                                                                        } ?>><?php echo $all_service_data['service_name']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                        <input type="hidden" name="edit_id" value="<?php echo $edit_id; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6" id="subservice_div">
                                                    <div class="form-group">
                                                        <label>Select Subservice : <span  class="text-danger">*</span></label>
                                                        <?php
                                                        if($service_sub_id !=''){
                                                        $all_sub_service_data_array = array();
                                                        $get_sub_service_query = "select * from sub_service where id IN($service_sub_id) and is_deleted='0'";
                                                        ...
                                                        ?>
                                                        <select class="select-search form-control" id="sub_service_id"  multiple="multiple"  name="sub_service_id[]">
                                                        <?php 
                                                        foreach ($all_sub_service_data_array as $all_sub_service_data)
                                                        { ?>
                                                            <option
                                                                <?php
                                                                    if (in_array($all_sub_service_data['id'], explode(',', $service_sub_id)))
                                                                    {
                                                                        echo " selected='selected'";
                                                                    }
                                                                    ?>
                                                                value="<?php echo $all_sub_service_data['id']; ?>"
                                                                <?php if ($all_sub_service_data['id'] == $service_sub_id)
                                                                {
                                                                    echo " selected='selected'";
                                                                } ?>>
                                                                <?php echo $all_sub_service_data['sub_service_name']; ?>
                                                            </option>
                                                        <?php } } ?>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="blog_name"
                                                               ...
                                                               data-parsley-required="true" value="<?php echo $blog_name; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                                ...
                                                                <div id="upload<?php echo $i; ?>"
                                                                    ...
                                                                    <ul class="" id="files<?php echo $i; ?>"
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            {
                                                                                ?>
                                                                                <img src="<?php echo $base_url; ?>uploads/blog-images/size_small/<?php echo $blog_image; ?>"
                                                                    ...
                                                                    <input type="hidden" name="file_name<?php echo $i; ?>" id="file_name<?php echo $i; ?>" value="<?php echo $blog_image; ?>">
                                                                </div>
                                                                <?php
                                                            } ?>
                                                            <div style="clear:both"></div>
