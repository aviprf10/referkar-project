...
if ($admin == 1)
{
	$temp_location = 'uploads/menu-small-images/temp_file/';
	$size_location1 = 'uploads/menu-small-images/size_extra_small/';
	$size_location2 = 'uploads/menu-small-images/size_small/';
	$size_location3 = 'uploads/menu-small-images/size_medium/';
	$size_location4 = 'uploads/menu-small-images/size_large/';
