...
if($admin == 1)
{
   if(($_POST))
   {
      ...
      $get_product_inquiry_query = "select * from product_inquiry where id='$delete_id' and is_deleted='0'";
      ...
      if(count($all_product_inquiry_data_array) > 0)
      {
         ...
         $update_product_inquiry_query = "update product_inquiry set is_deleted='1' where id='$delete_id'";
         $result_update_product_inquiry_query = mysqli_query($db_mysqli,$update_product_inquiry_query);
         if($result_update_product_inquiry_query)
         {
