...
{
    $module_full_name = "Service";
    $module_short_name = "Service";
    $module_name = "service";
     ...
     if (!empty($edit_data_array))
    {
        ...
        $service_name = $edit_data['service_name'];
                                            ...
                                            <div class="row">
                                                 <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" class="form-control"id="description" name="description" placeholder="Enter Description" rows="4" data-parsley-required="true"><?php echo $description; ?></textarea>                                                 
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
