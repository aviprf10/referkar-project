...
//        exit();
        ...
        $insert_category_query = "INSERT INTO category (category_name, category_unique_slug, meta_title, meta_keyword, meta_description, created_on, status, is_deleted) 
        VALUES ('$category_name','$category_unique_slug','$meta_title','$search_keywords','$meta_description', '$created_on','$status', '0')";
