                                ...
                                <div class="card">
                                    <table
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="search_blog" name="search_blog"
                                                       class="<?php echo $module_name; ?>-search-input form-control">
                                            </td>
                                            <td><input type="text" id="search_category" name="search_category"
                                                       class="<?php echo $module_name; ?>-search-input form-control">
                                            </td>
                                            <td><input type="text" id="search_service" name="search_service"
                                                       class="<?php echo $module_name; ?>-search-input form-control">
                                            </td>
                                            <td><input type="text" id="search_description" name="search_description"
                                                       class="<?php echo $module_name; ?>-search-input form-control">
                                            </td>
                                            <td></td>
                                            <td>
        ...
        <script type="text/javascript">
            ...
            function load_data(reset_flag = 0)
            {
                ...
                if (reset_flag == 0) 
                {
                    ...
                    form_data =
                    {
                        "search_blog": $('#search_blog').val(),
                        "search_description": $('#search_description').val(),
                        "search_category": $('#search_category').val(),
                        "search_service": $('#search_service').val(),
