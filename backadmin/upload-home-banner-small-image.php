...
{
	$temp_location = 'uploads/home-banner-small-images/temp_file/';
	$size_location1 = 'uploads/home-banner-small-images/size_extra_small/';
	$size_location2 = 'uploads/home-banner-small-images/size_small/';
	$size_location3 = 'uploads/home-banner-small-images/size_medium/';
	$size_location4 = 'uploads/home-banner-small-images/size_large/';
	...
	if(move_uploaded_file($_FILES['uploadfile']['tmp_name'], $source_image_path)) 
	{
		...
		resize_image($source_image_path, 300,100, $destination_file_name,$size_location4,75);
